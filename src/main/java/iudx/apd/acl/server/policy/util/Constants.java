...
public class Constants {
  ...
  public static final String SELECT_QUERY_4_PROVIDER_QUERY =
          "SELECT P._id AS \"policyId\", P.owner_id AS \"ownerId\", P.item_id AS \"itemId\", P.item_type AS \"itemType\", P.user_emailid AS \"consumerEmailId\", P.owner_id AS \"ownerId\", U.first_name AS \"consumerFirstName\", U.last_name AS \"consumerLastName\", U._id AS \"consumerId\", P.status AS \"status\", P.expiry_at AS \"expiryAt\", P.constraints AS \"constraints\"";

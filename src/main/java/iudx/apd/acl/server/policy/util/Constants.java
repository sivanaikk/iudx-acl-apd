...
public class Constants {
  ...
  public static final String CHECK_EXISTING_POLICY_1 =
          "where item_id =$1::UUID and item_type = $2::_item_type";
  ...
  public static final String PROVIDER_QUERY_2 = " P.item_type AS \"itemType\", P.user_emailid AS";
  ...
  public static final String CONSUMER_QUERY_1 =
          "SELECT P._id AS \"policyId\", P.item_id AS \"itemId\",";
  public static final String CONSUMER_QUERY_2 =
          " P.item_type AS \"itemType\", P.owner_id AS \"ownerId\",";
